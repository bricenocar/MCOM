...
export declare class TermPickerControl implements ComponentFramework.StandardControl<IInputs, IOutputs> {
     ...
     */
    updateView(context: ComponentFramework.Context<IInputs>): Promise<void>;
    private onChange;
    /**
     ...
     */
    getOutputs(): IOutputs;
    getOutputSchema(context: ComponentFramework.Context<IInputs>): Promise<Record<string, unknown>>;
    /**
