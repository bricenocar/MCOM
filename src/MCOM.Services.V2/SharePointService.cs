...
namespace MCOM.Services
{
    public interface ISharePointService
    {
        ...
        Task CreateCommunicationSite(PnPContext context, string url, string title, string description, PnP.Core.Admin.Model.SharePoint.Language language);
    ...
    public class SharePointService : ISharePointService
    {
        ...
        public virtual async Task SetListItemMetadata(Uri fileUri, string webUrl, Guid listId, string itemId, List<ListItemFormUpdateValue> itemMetadata)
        {
            try
            {
            ...
            {
                Global.Log.LogError(e, e.Message);
            }            
        }
        ...
        public async Task CreateCommunicationSite(PnPContext context, string url, string title, string description, PnP.Core.Admin.Model.SharePoint.Language language)
        {
            try
            {
